...
public class InvoicesPage extends TestBase {
	...
	@FindBy(id = "membershipPackage")
	WebElement membershipPackage;
	
	@FindBy(id = "grantTestDays")
	WebElement testDays;
	/***
	 * Constructor
	 * 
	...
	public void selectMembershipPackage(String membershipPkg) {
		util.selectByText(membershipPackage, membershipPkg, "Select Membership Package under the dropdown");
	}
	
	public void enterTestDays(String days) {
		util.fill(testDays, days, "Enter # of Test Days");
	}
}
