...
public class NavTabAndUserAssociationsOnMyAccountPage extends TestBase {
	...
	@FindBy(linkText = "Create Membership Invoice")
	WebElement ceateMembershipInvoice;
	/***
	 * Constructor
	 * 
	 * @param driver
	 ...
	 */
	public NavTabAndUserAssociationsOnMyAccountPage() {
	...
	public void clickOnCreateMembershipInvoiceLink() {
		util.click(ceateMembershipInvoice, "Click on Create Membership Invoice link");
	}
}
